...
\node[artifact,below=of api] (pre) {Input schema\\Original UCI codes};
\node[artifact,below=of predict] (model) {Saved preprocessing\\Logistic model\\32 background rows};
